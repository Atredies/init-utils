# Outdated Nextcould17 install script with all the setup from CLI
# This was copied from somewhere that I don't remember but it did have an MIT license
# Did small updates on it to work more smoothly
...
su - www-data -s /bin/bash -c 'php /var/www/nextcloud/occ config:system:set trusted_domains 1 --value=<IP_OF_SERVER>'
#su - www-data -s /bin/bash -c 'php /var/www/nextcloud/occ config:system:set overwrite.cli.url --value=https://$<IP_OF_SERVCER>$
echo ""
echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
...
###install ufw
apt install ufw -y
###open firewall ports HTTP_PORT+HTTPS_PORT for http(s)
ufw allow HTTP_PORT/tcp
ufw allow HTTPS_PORT/tcp
###open firewall port 15523 for SSH
ufw allow 15523/tcp
###open firewall port 16698 for VPN
ufw allow 16698/udp
